...
public class GridCacheRegistration {
    ...
    public static boolean registerCache() {
        ...
        try {
            ...
            Object registry = AEApi.instance()
                .registries()
                .getClass()
                .getMethod("gridCache")
                .invoke(
            ...
            if (registry != null) {
                ...
                AE2ChannelRouter.INSTANCE.getLogger()
                    .info("Successfully registered RoutingChannelCache with AE2");
                return true;
            }
        } catch (NoSuchMethodException e) {
            AE2ChannelRouter.INSTANCE.getLogger()
                .warn("GridCache API not available in this AE2 version: {}", e.getMessage());
        } catch (Exception e) {
            AE2ChannelRouter.INSTANCE.getLogger()
                .warn("Could not register RoutingChannelCache: {}", e.getMessage());
        }

        AE2ChannelRouter.INSTANCE.getLogger()
            .info("RoutingChannelCache registration skipped - using fallback mode");
        return false;
    }
